    ...
    <div>
      ...
      <div className="rounded-2xl border border-wind-gold/30 bg-gradient-to-br from-afterglow to-stage p-6 md:p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button className="rounded-full bg-wind-gold px-6 py-3 text-sm font-semibold text-stage transition-transform hover:-translate-y-0.5">
            지원서 작성하기
          </button>
          <KakaoShareButton
            label="친구에게 모집 소식 공유하기"
            templateArgs={{
              title: "이번 바람은, 당신 차례. 춤바람 신입부원 모집",
              description: "2026년 2학기 춤바람 신입부원을 모집합니다. 경력 무관, 지원 기간 8/18~9/1.",
