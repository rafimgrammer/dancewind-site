import { S as createAtomBlockMarkdownSpec, Zt as nodePasteRule, qt as mergeAttributes, u as Node3 } from "./dist-nr6-ZQIw.js";
//#region node_modules/@tiptap/extension-youtube/dist/index.js
...
var getEmbedUrlFromYoutubeUrl = (options) => {
	...
	const matches = /(?:(v|list)=|shorts\/)([-\w]+)/gm.exec(url);
...
var getAttributesFromYoutubeEmbedUrl = (url) => {
	...
	if (parsedUrl.pathname === "/embed/videoseries") {
		...
		if (!(matches == null ? void 0 : matches[1])) return null;
...
//#endregion
export { Youtube, index_default as default, getAttributesFromYoutubeEmbedUrl, getEmbedUrlFromYoutubeUrl, isValidYoutubeUrl };
